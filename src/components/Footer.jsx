        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          <div className="lg:col-span-2">
            <a href="#home" className="text-xl font-bold text-white">
              ...
              <p className="text-sm font-light">Learn Skills. Build Careers.</p>
            </a>
            <p className="mt-3 text-sm text-white/70 max-w-xs">
              Empowering your learning journey with expert-led courses, flexible plans, and a
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              {quickLinks.map((l) => (
                <li key={l.label}>
                  <a href={l.href} className="text-sm text-white/70 hover:text-white transition">
                    {l.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/70">
              <li>
                <a href="mailto:hello@TECHNO 7 INTERNATIONAL.com" className="hover:text-white transition">
                  www.techno7international.com
                </a>
              </li>
              <li>
